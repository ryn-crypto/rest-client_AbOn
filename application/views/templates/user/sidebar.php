...
<aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="brand-link">
      <img src="<?= base_url('assets/') ?>images/accessoris/Logo.png" alt="Throne Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light"><h4 class="font-weight-bold">Absensi Online</h4></span>
    </div>
